...
CREATE TABLE IF NOT EXISTS `branch` (
  ...
  `bra_cnt_id` int(11) NOT NULL DEFAULT '0',
  `bra_city` varchar(45) NOT NULL,
  `bra_add_str` varchar(45) NOT NULL,
  `bra_add_1` text NOT NULL,
  `bra_tel_1` varchar(128) NOT NULL,
  `bra_tel_2` varchar(128) NOT NULL,
  `bra_fax` varchar(128) NOT NULL,
  `bra_email` varchar(128) NOT NULL,
  `bra_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`bra_id`)
...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `cat_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`cat_id`)
...
CREATE TABLE IF NOT EXISTS `country` (
  ...
  `cnt_name` varchar(80) NOT NULL DEFAULT ' ',
  `cnt_nicename` varchar(80) NOT NULL DEFAULT ' ',
  `cnt_iso3` char(3) NOT NULL,
  `cnt_numcode` smallint(6) NOT NULL DEFAULT '0',
  `cnt_phonecode` int(5) NOT NULL DEFAULT '0',
  `cnt_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`cnt_id`)
...
(8, 'AQ', 'ANTARCTICA', 'Antarctica', '', 0, 0, '2014-07-04 07:15:55'),
...
(29, 'BV', 'BOUVET ISLAND', 'Bouvet Island', '', 0, 0, '2014-07-04 07:15:55'),
(30, 'BR', 'BRAZIL', 'Brazil', 'BRA', 76, 55, '2014-07-04 07:15:55'),
(31, 'IO', 'BRITISH INDIAN OCEAN TERRITORY', 'British Indian Ocean Territory', '', 0, 246, '2014-07-04 07:15:55'),
...
(45, 'CX', 'CHRISTMAS ISLAND', 'Christmas Island', '', 0, 61, '2014-07-04 07:15:55'),
(46, 'CC', 'COCOS (KEELING) ISLANDS', 'Cocos (Keeling) Islands', '', 0, 672, '2014-07-04 07:15:55'),
...
(76, 'TF', 'FRENCH SOUTHERN TERRITORIES', 'French Southern Territories', '', 0, 0, '2014-07-04 07:15:55'),
...
(93, 'HM', 'HEARD ISLAND AND MCDONALD ISLANDS', 'Heard Island and Mcdonald Islands', '', 0, 0, '2014-07-04 07:15:55'),
...
(137, 'YT', 'MAYOTTE', 'Mayotte', '', 0, 269, '2014-07-04 07:15:55'),
...
(164, 'PS', 'PALESTINIAN TERRITORY, OCCUPIED', 'Palestinian Territory, Occupied', '', 0, 970, '2014-07-04 07:15:55'),
...
(189, 'CS', 'SERBIA AND MONTENEGRO', 'Serbia and Montenegro', '', 0, 381, '2014-07-04 07:15:55'),
...
(198, 'GS', 'SOUTH GEORGIA AND THE SOUTH SANDWICH ISLANDS', 'South Georgia and the South Sandwich Islands', '', 0, 0, '2014-07-04 07:15:55'),
...
(212, 'TL', 'TIMOR-LESTE', 'Timor-Leste', '', 0, 670, '2014-07-04 07:15:55'),
...
(227, 'UM', 'UNITED STATES MINOR OUTLYING ISLANDS', 'United States Minor Outlying Islands', '', 0, 1, '2014-07-04 07:15:55'),
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `cust_comp` varchar(128) NOT NULL,
  `cust_name` varchar(128) NOT NULL,
  `cust_title` varchar(4) NOT NULL,
  `cust_add_1` text NOT NULL,
  `cust_add_2` text NOT NULL,
  `cust_city` varchar(128) NOT NULL,
  `cust_cnt_id` int(11) NOT NULL DEFAULT '0',
  `cust_tel_1` varchar(128) NOT NULL,
  `cust_tel_2` varchar(128) NOT NULL,
  `cust_fax` varchar(128) NOT NULL,
  `cust_email` varchar(256) NOT NULL,
  `cust_site` varchar(256) NOT NULL,
  `cust_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`cust_id`)
...
INSERT INTO `customer` (`cust_id`, `cust_comp`, `cust_name`, `cust_title`, `cust_add_1`, `cust_add_2`, `cust_city`, `cust_cnt_id`, `cust_tel_1`, `cust_tel_2`, `cust_fax`, `cust_email`, `cust_site`, `cust_time_stamp`) VALUES
(1, 'vdfsv', 'Hala', 'Ms.', 'vfdsvb', ' czx ', '123', 118, '5646', '456', '56', 'vdfs', 'vcds', '2014-09-15 20:13:05'),
(6, 'q', 'Wadih', 'Mr.', 'q', 'q', 'q', 118, 'q', 'q', 'q', 'q', 'q', '2014-09-18 20:27:40'),
(7, 'k', 'Henry', 'Mr.', 'k', 'k', 'k', 109, 'k', 'k', 'k', 'k', 'k', '2014-09-18 20:28:06');
...
CREATE TABLE IF NOT EXISTS `invoice_in` (
  ...
  `inv_in_ord_in_id` int(11) NOT NULL DEFAULT '0',
  `inv_in_cust_id` int(11) NOT NULL DEFAULT '0',
  `inv_in_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `inv_in_num` varchar(45) NOT NULL,
  `inv_in_total` double NOT NULL DEFAULT '0',
  `inv_in_tax` double NOT NULL DEFAULT '0',
  `inv_in_disc` double NOT NULL DEFAULT '0',
  `inv_in_total_due` double NOT NULL DEFAULT '0',
  `inv_in_status` int(11) NOT NULL DEFAULT '0',
  `inv_in_att` varchar(256) NOT NULL DEFAULT '',
  `inv_in_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
INSERT INTO `invoice_in` (`inv_in_id`, `inv_in_ord_in_id`, `inv_in_cust_id`, `inv_in_date`, `inv_in_num`, `inv_in_total`, `inv_in_tax`, `inv_in_disc`, `inv_in_total_due`, `inv_in_status`, `inv_in_att`, `inv_in_time_stamp`) VALUES
(1, 1, 1, '2014-10-14 00:00:00', '1', 1000, 0.1, 0, 1100, 1, 'none', '2014-10-14 00:00:00');
...
CREATE TABLE IF NOT EXISTS `invoice_in_detail` (
  ...
  `inv_in_det_inv_id` int(11) NOT NULL DEFAULT '0',
  `inv_in_det_prod_id` int(11) NOT NULL DEFAULT '0',
  `inv_in_det_qty` int(11) NOT NULL DEFAULT '0',
  `inv_in_det_up` double NOT NULL DEFAULT '0',
  `inv_in_det_total` double NOT NULL DEFAULT '0',
  `inv_in_det_disc` double NOT NULL DEFAULT '0',
  `inv_in_det_total_due` double NOT NULL DEFAULT '0',
  `inv_in_det_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `invoice_out` (
  ...
  `inv_out_ord_out_id` int(11) NOT NULL DEFAULT '0',
  `inv_out_sup_id` int(11) NOT NULL DEFAULT '0',
  `inv_out_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `inv_out_num` varchar(45) NOT NULL,
  `inv_out_total` double NOT NULL DEFAULT '0',
  `inv_out_tax` double NOT NULL DEFAULT '0',
  `inv_out_disc` double DEFAULT '0',
  `inv_out_total_due` double NOT NULL DEFAULT '0',
  `inv_out_status` int(11) NOT NULL DEFAULT '0',
  `inv_out_att` varchar(256) NOT NULL,
  `inv_out_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `invoice_out_detail` (
  ...
  `inv_out_det_inv_id` int(11) NOT NULL DEFAULT '0',
  `inv_out_det_prod_id` int(11) NOT NULL DEFAULT '0',
  `inv_out_det_qty` int(11) NOT NULL DEFAULT '0',
  `inv_out_det_up` double NOT NULL DEFAULT '0',
  `inv_out_det_total` double NOT NULL DEFAULT '0',
  `inv_out_det_disc` double NOT NULL DEFAULT '0',
  `inv_out_det_tota_due` double NOT NULL DEFAULT '0',
  `inv_out_det_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `order_in` (
  ...
  `ord_in_status` int(11) NOT NULL DEFAULT '0',
  `ord_in_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `order_in_detail` (
  ...
  `ord_in_det_ord_in_id` int(11) NOT NULL DEFAULT '0',
  `ord_in_det_prod_id` int(11) NOT NULL DEFAULT '0',
  `ord_in_det_qty` int(11) NOT NULL DEFAULT '0',
  `ord_in_det_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`ord_in_det_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;

--
-- Dumping data for table `order_in_detail`
--
...
CREATE TABLE IF NOT EXISTS `order_out` (
  ...
  `ord_out_sup_id` varchar(45) NOT NULL DEFAULT '0',
  `ord_out_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `ord_out_del_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `ord_out_status` int(11) NOT NULL DEFAULT '0',
  `ord_out_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
INSERT INTO `order_out` (`ord_out_id`, `ord_out_sup_id`, `ord_out_date`, `ord_out_del_date`, `ord_out_status`, `ord_out_time_stamp`) VALUES
(4, '3', '2014-09-02 00:00:00', '0000-00-00 00:00:00', 0, '2014-09-30 14:30:04'),
(5, '2', '2014-09-09 00:00:00', '0000-00-00 00:00:00', 0, '2014-09-30 15:57:46'),
(6, '1', '2014-09-15 00:00:00', '0000-00-00 00:00:00', 0, '2014-09-30 18:32:23');
...
CREATE TABLE IF NOT EXISTS `order_out_detail` (
  ...
  `ord_out_det_ord_out_id` int(11) NOT NULL DEFAULT '0',
  `ord_out_det_prod_id` int(11) NOT NULL DEFAULT '0',
  `ord_out_det_qty` int(11) NOT NULL DEFAULT '0',
  `ord_out_det_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`ord_out_det_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9 ;

--
-- Dumping data for table `order_out_detail`
--

INSERT INTO `order_out_detail` (`ord_out_det_id`, `ord_out_det_ord_out_id`, `ord_out_det_prod_id`, `ord_out_det_qty`, `ord_out_det_time_stamp`) VALUES
(5, 4, 3, 12, '2014-09-30 15:56:07'),
(6, 4, 1, 11, '2014-09-30 15:56:13'),
(7, 6, 1, 12, '2014-09-30 18:32:45'),
(8, 6, 3, 2, '2014-09-30 18:33:07');
...
CREATE TABLE IF NOT EXISTS `page` (
  ...
  `page_acl` int(11) NOT NULL DEFAULT '0',
  `page_in_menu` tinyint(4) NOT NULL DEFAULT '0',
...
(23, 22, 'Delete Customer', '/cust/delete.php', 2, 1, 0, '2014-09-15 21:02:12'),
(24, 16, 'Add Product', '/prod/add.php', 2, 1, 0, '2014-09-15 21:08:38'),
(25, 11, 'Supplier Management', '/sup/show.php', 1, 1, 0, '2014-09-15 22:14:03'),
(26, 25, 'Delete Supplier', '/sup/delete.php', 2, 0, 0, '2014-09-15 22:32:37'),
(27, 16, 'Delete Product', '/prod/delete.php', 2, 0, 0, '2014-09-15 22:39:46'),
...
(32, 25, 'Add Supplier', '/sup/add.php', 2, 0, 1, '2014-09-18 00:00:00'),
(33, 11, 'Shipper Management', '/ship/show.php', 2, 1, 1, '2014-09-20 12:47:02'),
(34, 33, 'Add shipper', '/ship/add.php', 2, 0, 1, '2014-09-20 12:48:17'),
(35, 33, 'Edit shipper', '/ship/edit.php', 2, 0, 1, '2014-09-20 12:49:34'),
(36, 33, 'Delete shipper', '/ship/delete.php', 2, 0, 1, '2014-09-20 12:49:45'),
(37, 21, 'Add Transfert', '/trans/add.php', 3, 0, 1, '2014-09-20 14:01:54'),
(38, 21, 'Order In', '/orderIn/show.php', 3, 1, 1, '2014-09-20 15:06:31'),
(39, 21, 'Order Out', '/orderOut/show.php', 3, 1, 2, '2014-09-26 21:27:41'),
(40, 21, 'Delete Order Out', '/orderOut/delete.php', 3, 0, 1, '2014-10-07 20:22:04'),
(42, 21, 'Delete Order In Detail', '/orderIn/deleteOrderInDetail.php', 3, 0, 1, '2014-10-07 21:04:06'),
(43, 21, 'Delete Order Out Detail', '/orderOut/deleteOrderOutDetail.php', 3, 0, 1, '2014-10-07 21:04:32'),
(44, 21, 'Invoice In', '/invoiceIn/show.php', 3, 1, 1, '2014-10-14 19:40:09'),
(45, 21, 'Invoice Out', '/invoiceOut/show.php', 3, 1, 4, '2014-10-14 19:40:22'),
(46, 44, 'Create Invoice', '/invoicein/add.php', 3, 1, 1, '2014-10-14 19:58:00'),
(47, 21, 'Reports', '/rep/dash.php', 3, 1, 1, '2014-10-22 18:22:01'),
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `prod_cat_id` int(11) NOT NULL DEFAULT '0' COMMENT 'This is linked to the categories table (Electronics, Computers, Clothes...) it depends on the project purpose',
  `prod_sku` varchar(128) NOT NULL COMMENT 'The Stock Keeping Unit is a unique identifier defined by your company. For example, your comapny may assign a gallon of Tropicana orange juice a SKU of TROPOJ100. Most times, the SKU is represented by the manufacturer''s UPC',
  `prod_upc` varchar(128) NOT NULL COMMENT 'The Universal Product Code is a unique and standrad identifier typically shown under the bar code symbol on retail packaging in the United States (BARCODE)',
  `prod_name` varchar(128) NOT NULL,
  `prod_desc` text NOT NULL,
  `prod_qty` int(11) NOT NULL DEFAULT '0' COMMENT 'the global quantity (this is the sum of all qty in all branches)',
  `prod_color` varchar(128) NOT NULL,
  `prod_size` varchar(45) NOT NULL,
  `prod_weight` double NOT NULL DEFAULT '0',
  `prod_sup_id` int(11) NOT NULL DEFAULT '0' COMMENT 'Foreigh Key to the supplier table',
  `prod_up` double NOT NULL DEFAULT '0',
  `prod_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'The status is to know if this product is available (1) or not (0)',
  `prod_vend_id` int(11) NOT NULL DEFAULT '0' COMMENT 'A link to the vendor (ex: band like nike, nokia, samsung...)',
  `prod_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'creation date',
  PRIMARY KEY (`prod_id`),
...
--
-- Table structure for table `prod_bra`
--

CREATE TABLE IF NOT EXISTS `prod_bra` (
  `pb_id` int(11) NOT NULL AUTO_INCREMENT,
  `pb_prod_id` int(11) NOT NULL,
  `pb_bra_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `role` (
  ...
  `role_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;
...
(1, 'Admin', '', '2014-07-16 13:00:32'),
(2, 'Manager', '', '2014-07-16 13:00:32'),
(3, 'User', '', '2014-07-16 13:00:32');
...
CREATE TABLE IF NOT EXISTS `shipper` (
  ...
  `ship_add_1` text NOT NULL,
  `ship_add_2` text NOT NULL,
  `ship_tel_1` varchar(128) NOT NULL,
  `ship_tel_2` varchar(128) NOT NULL,
  `ship_fax` varchar(128) NOT NULL,
  `ship_email` varchar(128) NOT NULL,
  `ship_taxable` tinyint(4) NOT NULL DEFAULT '0',
  `ship_time_stamp` datetime DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`ship_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `stock` (
  ...
  `stock_prod_id` int(11) DEFAULT '0',
  `stock_bra_id` int(11) DEFAULT '0',
  `stock_qty` int(11) DEFAULT '0',
  `stock_time_stamp` datetime DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `supplier` (
  ...
  `sup_comp` varchar(128) NOT NULL,
  `sup_name` varchar(128) NOT NULL,
  `sup_title` varchar(4) NOT NULL,
  `sup_add_1` text NOT NULL,
  `sup_add_2` text NOT NULL,
  `sup_city` varchar(128) NOT NULL,
  `sup_cnt_id` int(11) NOT NULL DEFAULT '0',
  `sup_tel_1` varchar(128) NOT NULL,
  `sup_tel_2` varchar(128) NOT NULL,
  `sup_fax` varchar(128) NOT NULL,
  `sup_email` varchar(256) NOT NULL,
  `sup_site` varchar(256) NOT NULL,
  `sup_logo` varchar(128) NOT NULL DEFAULT 'none',
  `sup_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`sup_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;
...
(1, 'Comp1', 'Georges Al-Tawil', 'Mr.', 'vfds', 'vfsd', 'vfsd', 226, 'vfds', 'vfsd', 'vfsd', 'vfsd', 'vfds', 'none', '2014-09-15 22:11:54'),
(2, 'Comp2', 'Raymond Mhanna', 'Ms.', 'asd', 'asd', 'asd', 118, '123', '123', '123', 'asd@sadf.com', 'asd', 'none', '2014-09-15 22:21:20'),
(3, 'q', 'Georges Kfoury', 'Mr.', '1', '1', '1', 1, '1', '1', '1', '1', '1', 'none', '0000-00-00 00:00:00'),
(4, 'TEST', 'Wadih Maksoud', 'Mr.', 'asdasdasd', 'adadasd', 'Beirut', 118, '123123123', '123123123', '123123123', 'wadih@wadih.com', 'www.asdas.com', 'null', '2014-09-30 19:01:01');
...
CREATE TABLE IF NOT EXISTS `tracking` (
  ...
  `track_trans_id` int(11) NOT NULL DEFAULT '0',
  `track_ship_id` int(11) NOT NULL DEFAULT '0',
  `track_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `transfert` (
  ...
  `trans_src_bra_id` int(11) NOT NULL DEFAULT '0',
  `trans_dest_bra_id` int(11) NOT NULL DEFAULT '0',
  `trans_send_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `trans_del_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `trans_status` int(11) NOT NULL DEFAULT '0',
  `trans_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
INSERT INTO `transfert` (`trans_id`, `trans_src_bra_id`, `trans_dest_bra_id`, `trans_send_date`, `trans_del_date`, `trans_status`, `trans_time_stamp`) VALUES
(1, 2, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, '0000-00-00 00:00:00'),
(2, 2, 3, '2014-10-01 00:00:00', '0000-00-00 00:00:00', 0, '2014-10-02 19:31:23');
...
CREATE TABLE IF NOT EXISTS `trans_detail` (
  ...
  `trans_det_trans_id` int(11) NOT NULL,
  `trans_det_prod_id` int(11) NOT NULL,
  `trans_det_qty` int(11) NOT NULL,
  `trans_det_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
INSERT INTO `trans_detail` (`trans_det_id`, `trans_det_trans_id`, `trans_det_prod_id`, `trans_det_qty`, `trans_det_time_stamp`) VALUES
(2, 1, 1, 10, '2014-09-20 14:49:49'),
(3, 1, 1, 1, '2014-10-02 19:07:17'),
(4, 1, 1, 1, '2014-10-02 19:09:19'),
(5, 1, 1, 1, '2014-10-02 19:33:34');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `user_time_stamp` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;
